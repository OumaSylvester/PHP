...
<nav class="col-sm-2">
	<div class="btn-group-vertical btn-group-sm" role="group" aria-label="Button Group">
		...
		<button type="button" class="btn btn-secondary" onclick="location.href='<?php if($_SESSION['user_level'] == 0) echo "members-page.php"; else echo "admin-page.php";?>'">Cancel</button>
	</div>	
</nav>