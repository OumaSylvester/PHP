<?php
	try {
		...
		$query = "SELECT last_name, first_name, email, DATE_FORMAT(registration_date, '%M %d, %Y') AS regdat, user_id FROM users WHERE last_name=? AND first_name=? ORDER BY regdat ASC";
