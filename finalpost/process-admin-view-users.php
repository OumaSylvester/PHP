<?php 
	try{
		...
		$query = "SELECT last_name, first_name, email, DATE_FORMAT(registration_date, '%M %d, %Y') AS regdat,class, paid, user_id FROM users ORDER BY registration_date DESC LIMIT ?, ?";
